  ...
  return (
    <div className="h-full flex flex-col font-sans bg-[#f8fafc] text-slate-700 select-text">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <aside className={`w-full lg:w-64 xl:w-80 border-r border-slate-200 bg-white flex flex-col shrink-0 z-10 shadow-sm ${mobileViewTab === 'drivers' ? 'flex' : 'hidden lg:flex'
          }`}>
          {/* Search Box */}
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-1 mb-0.5">
                        <span className="text-sm font-bold text-slate-900 truncate font-outfit flex items-center gap-1.5">
                          {d.name}
                          {d.ml_score !== undefined && d.ml_score !== null && (
                            <span
                              className="inline-flex items-center text-[10px] text-violet-500 font-bold shrink-0 select-none"
                              title={`AI Safety Score (ML: ${d.ml_score} vs Rule-Based: ${d.rule_based_score})`}
                            >
                              🤖
                              <span className={`w-1.5 h-1.5 rounded-full ml-0.5 ${Math.abs(d.ml_score - d.rule_based_score) > 5.0
                                  ? 'bg-amber-500'
        ...
        <main className="flex-1 flex overflow-hidden">
          {!activeDriverId ? (
            ...
            <>
              ...
              <section className={`w-full lg:w-64 xl:w-80 border-r border-slate-200 bg-white flex flex-col shrink-0 z-0 ${mobileViewTab === 'journeys' ? 'flex' : 'hidden lg:flex'
                }`}>
                                  ...
                                  <div>
                                    ...
                                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8 mb-5 w-full">
                                      ...
                                      <div className="w-full sm:max-w-[210px] space-y-1.5 text-[11px] shrink-0">
                                        ...
                                        <div className="flex items-center justify-between gap-2 text-slate-600 p-1 hover:bg-slate-50 rounded-xl transition-all duration-200">
                                          <span className="font-bold text-slate-600 flex items-center gap-2 select-none shrink-0">
                                            <span className={`w-2 h-2 rounded-full shrink-0 ${journeyDetails.journey.brake_events === 0 ? 'bg-emerald-500 shadow-sm shadow-emerald-400' : (journeyDetails.journey.brake_events < 4 ? 'bg-amber-500' : 'bg-rose-500')
                                              }`} />
                                            Harsh Braking
                                          </span>
                                          <span className="font-extrabold text-slate-700 shrink-0 bg-slate-100/80 px-2 py-0.5 rounded-lg text-[9.5px] font-outfit select-none">
                                        ...
                                        <div className="flex items-center justify-between gap-2 text-slate-600 p-1 hover:bg-slate-50 rounded-xl transition-all duration-200">
                                          <span className="font-bold text-slate-600 flex items-center gap-2 select-none shrink-0">
                                            <span className={`w-2 h-2 rounded-full shrink-0 ${journeyDetails.journey.overspeed_count === 0 ? 'bg-emerald-500 shadow-sm shadow-emerald-400' : (journeyDetails.journey.overspeed_count < 2 ? 'bg-amber-500' : 'bg-rose-500')
                                              }`} />
                                            Overspeeding
                                          </span>
                                          <span className="font-extrabold text-slate-700 shrink-0 bg-slate-100/80 px-2 py-0.5 rounded-lg text-[9.5px] font-outfit select-none">
                        ...
                        <div className="bg-white rounded-3xl border border-slate-200/80 p-6 shadow-premium flex flex-col justify-between hover:shadow-premium-lg transition-shadow">
                          <div>
                            ...
                            <div className={`p-4 rounded-2xl flex flex-col sm:flex-row xl:flex-col 2xl:flex-row items-start sm:items-center xl:items-start 2xl:items-center gap-4 mb-5 border transition-all ${journeyDetails.fuel_theft.detected
                              ...
                              <div className={`w-9 h-9 rounded-xl flex items-center justify-center shrink-0 ${journeyDetails.fuel_theft.detected ? 'bg-rose-500 text-white' : 'bg-emerald-500 text-white'
                                }`}>
